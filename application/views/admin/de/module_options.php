...
$aLang = [
    'charset'                               => 'UTF-8',
    'SHOP_MODULE_GROUP_vtchildtplmod'    => $style.'Einstellungen',
    'SHOP_MODULE_blVtctpmLogReplaced'    => 'log overriden templates',
    'SHOP_MODULE_blVtctpmLogReplaceable' => 'log templates, that could be overriden'
];
